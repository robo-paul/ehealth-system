// src/pages/admin/UserVerificationPage.js
...
const UserVerificationPage = () => {
    ...
    return (
        <div className="admin-page">
                        ...
                        <tbody>
                            {displayUsers.map(user => (
                                <tr key={user.id}>
                                    ...
                                    <td>
                                        {user.requested_role ? getRoleDisplayName(user.requested_role) : '-'}
                                    </td>
                                            ...
                                            <>
                                                <button 
                                                    ...
                                                    onClick={() => {
                                                        ...
                                                        setSelectedRole(user.requested_role || user.role);
                                                    }}
                                                >
                                                    Verify
                                                </button>
                ...
                <div className="modal-overlay" onClick={() => setSelectedUser(null)}>
                    <div className="modal-content" onClick={e => e.stopPropagation()}>
                        ...
                        {selectedUser.requested_role && (
                            <p>Requested Role: <strong>{getRoleDisplayName(selectedUser.requested_role)}</strong></p>
                        )}
            ...
            {/* Change Role Modal */}
            {selectedUser && selectedUser.verification_status === 'approved' && (
                <div className="modal-overlay" onClick={() => setSelectedUser(null)}>
                    <div className="modal-content" onClick={e => e.stopPropagation()}>
